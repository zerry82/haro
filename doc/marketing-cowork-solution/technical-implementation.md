...
이 구현의 목적은 마케팅 코워크 솔루션의 핵심 실행환경을 제품 기능으로 구체화하는 것이다.

이 문서는 수요검증 문서가 아니다. 고객이 이 제품을 원하는지, 어떤 가격을 낼지, 어떤 포지셔닝이 맞는지를 확인하는 단계가 아니다.

구현이 답해야 할 핵심 질문은 다음이다.
...
즉, 목표는 다음 최소 기술 루프를 안정적으로 제공하는 것이다.
...
기술 구현 단계에서도 다음 요구사항은 최소한으로 고려한다.
...
다음 단계에서는 이 문서를 바탕으로 실제 구현안을 정한다.
